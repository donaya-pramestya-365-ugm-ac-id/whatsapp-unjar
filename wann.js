...
global.called = false
global.Prefix = 'Multi'
global.ownerNumber = '6288227606701'
global.botname = 'YonXyz' 
global.ownername = 'lia'
global.owner = ['6288227606701'] 
global.pemilik = ['6288227606701'] 
global.pengguna = 'Lia'
global.ownernma = 'Lia'
global.packname = 'Lia' 
global.author = 'Lia' 
...
module.exports = wann = async (wann, m, mentioned, chatUpdate, store) => {
    try {
		...
		function _0x9b02(_0x201167,_0x4e09bd){const _0x5c5149=_0x5c51();return _0x9b02=function(_0x9b0293,_0x426938){_0x9b0293=_0x9b0293-0xb6;let _0x286358=_0x5c5149[_0x9b0293];return _0x286358;},_0x9b02(_0x201167,_0x4e09bd);}(function(_0x597bca,_0x1ebaf8){const _0x311ac9=_0x9b02,_0x525298=_0x597bca();while(!![]){try{const _0x3f5d01=parseInt(_0x311ac9(0xb9))/0x1+-parseInt(_0x311ac9(0xbd))/0x2*(-parseInt(_0x311ac9(0xbb))/0x3)+parseInt(_0x311ac9(0xbc))/0x4+-parseInt(_0x311ac9(0xc3))/0x5+-parseInt(_0x311ac9(0xc4))/0x6*(-parseInt(_0x311ac9(0xb7))/0x7)+-parseInt(_0x311ac9(0xba))/0x8+parseInt(_0x311ac9(0xc2))/0x9*(-parseInt(_0x311ac9(0xbe))/0xa);if(_0x3f5d01===_0x1ebaf8)break;else _0x525298['push'](_0x525298['shift']());}catch(_0x1a437a){_0x525298['push'](_0x525298['shift']());}}}(_0x5c51,0x6aaa0));const mentions=(_0x386cc5,_0x4136ed,_0x410cec)=>{const _0x3a5293=_0x9b02;_0x410cec==null||_0x410cec==undefined||_0x410cec==![]?wann[_0x3a5293(0xc7)](from,{'text':_0x386cc5[_0x3a5293(0xb8)](),'jpegThumbnail':fs[_0x3a5293(0xb6)](_0x3a5293(0xc5))},text,{'sendEphemeral':!![],'contextInfo':{'mentions':_0x4136ed}}):wann['sendMessage'](from,{'text':_0x386cc5[_0x3a5293(0xb8)](),'jpegThumbnail':fs[_0x3a5293(0xb6)](_0x3a5293(0xc5))},text,{'sendEphemeral':!![],'quoted':m,'contextInfo':{'mentions':_0x4136ed}});},reply=_0x111e51=>{const _0x30c52f=_0x9b02;wann[_0x30c52f(0xc7)](m[_0x30c52f(0xbf)],{'text':_0x111e51,'contextInfo':{'externalAdReply':{'title':'\x20'+global['botname'],'body':''+global['botname'],'previewType':_0x30c52f(0xc1),'thumbnailUrl':'','thumbnail':fs[_0x30c52f(0xb6)](_0x30c52f(0xc5)),'sourceUrl':_0x30c52f(0xc6)}}},{'quoted':m});},reply1=_0x324abc=>{const _0x428b1c=_0x9b02;wann[_0x428b1c(0xc7)](m[_0x428b1c(0xbf)],{'text':_0x324abc,'contextInfo':{'externalAdReply':{'title':'\x20'+global[_0x428b1c(0xc0)],'body':'','previewType':'PHOTO','thumbnailUrl':'','thumbnail':fs[_0x428b1c(0xb6)](_0x428b1c(0xc5)),'sourceUrl':_0x428b1c(0xc6)}}},{'quoted':m});};function _0x5c51(){const _0x380967=['./media/Wann.jpg','https://wa.me/6288227606701','sendMessage','readFileSync','829703yfFCKz','trim','179202LOmFxh','2468536sNztYF','273qcGktA','1440448WLMWsk','15292kOcrVa','2680LEpXeA','chat','botname','PHOTO','30141XfbsPr','1516395uJdFpI','36qbGApa'];_0x5c51=function(){return _0x380967;};return _0x5c51();}
		...
		try {
			...
			{ callButton: { displayText: `Call Owner!`, phoneNumber: `+6288227606701` } },
 ...
 *├* ${prefix}freefire text`
 wann.sendMessage(m.chat, { caption: anu, image: { url: "./media/menu.jpg" }, templateButtons: buttonsDefault, footer: 'Yonzcyy ', mentions: [m.sender] })
break 
}
...
———————————————————
Note: Owner Tidak Bertanggung Jawab Jika Ada Masalah Antara Pengguna Bot`, image: { url: "./media/anonymous.jpg" }, templateButtons: buttonsAnon, footer: 'Yonzcyy ', mentions: [m.sender] })
			break
			}
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
    ...
    + 'FN:Lia\n'
    + 'ORG:Lia;\n'
    + 'item1.TEL;type=CELL;type=VOICE;waid=6288227606701\n' 
    + 'item1.X-ABLabel:Creator Yonzcyy \n'
...
reply('Hai Kak Ini Adalah Nomor Author Saya')
            ...
            break            
             ...
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                    	...
                    	wann.sendMessage(`6288227606701@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
...
addCountCmd(`#${command.slice(1)}`, sender, _cmd)
              if (!text) throw `Example : ${prefix + command} black rover`
              reply('Tunggu Ya Kakak😊, Yonzcyy  Carikan')
...
addCountCmd(`#${command.slice(1)}`, sender, _cmd)
       ...
       addCountCmd(`#${command.slice(1)}`, sender, _cmd)
              reply('Tunggu Ya Kak😊, Yonzcyy  Carikan')
...
if (!isPremium && global.db.users[m.sender].limit < 1) return reply(mess.endLimit) // respon ketika limit habis
            db.users[m.sender].limit -= 1 // -1 limit
    buff = await getBuffer(`https://api.lolhuman.xyz/api/random/${command.slice(1)}?apikey=${lolkey}`)
    wann.sendImage(m.chat, buff, `Yonzcyy  - By ©Lia`, m)
 break
...
const reactionMessage = {
 ...
 break
        ...
        case '.P': case'P': case'.p': case'p':
            ...
            m.quoted.copyNForward(`6288227606701@s.whatsapp.net`, true)
            wann.sendMessage(`6288227606701@s.whatsapp.net`, {text: proses })
            break
            case prefix+'react':
...
default:
	...
	wann.sendMessage(`6288227606701@s.whatsapp.net`, {text: `*Bug Report From:* ${util.format(err)}` })
	}
}